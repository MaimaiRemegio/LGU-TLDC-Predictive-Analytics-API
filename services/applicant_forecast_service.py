"""
Applicant volume forecasting service for the LGU-TLDC Predictive Analytics API.

Loads the pre-trained ARIMA bundle once and serves TLDC-wide forecasts
by planning period, aggregating all barangay and course time series.
"""
